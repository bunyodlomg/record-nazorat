...
function KpiCard({ label, value = 0, suffix = '', icon, iconBg, iconColor }) {
  ...
  return (
    <motion.div className="kpi"
      variants={listItem}
      whileHover={!CAN_HOVER ? undefined : { y:-4 }}
  ...
  return (
    <motion.div className="page"
      ...
      <motion.div className="kpi-grid" variants={listContainer} initial="hidden" animate="show">
        ...
        <KpiCard label="O'rtacha tekshiruv" value={kpis.avgCompletion ?? kpis.avgAttendance} suffix="%" icon="activity" iconBg="var(--amber-bg)" iconColor="var(--amber)"/>
